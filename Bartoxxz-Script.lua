...
Character.Head.CustomPlayerTag.MinerRank.Text = "G.O.A.T🐐"
                        ...
                        local objectsToRemove = {workspace.VIPMine:GetChildren()[13],workspace.Activation.Buy,workspace.VIPMine.Anvil,workspace.PrivateMinePart2,workspace.PrivateMinePart};
